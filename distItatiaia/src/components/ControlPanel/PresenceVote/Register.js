                    ...
                    react_1.default.createElement("label", { className: "flex flex-col" },
                        ...
                        buttonClose
                            ? react_1.default.createElement("select", { onChange: (e) => setResultVoteForm(e.target.value), value: resultVoteForm, className: "border rounded-md p-2" },
                                ...
                                react_1.default.createElement("option", { value: 5 }, "APROVADO POR UNANIMIDADE"),
                                react_1.default.createElement("option", { value: 6 }, "REPROVADA"),
                                react_1.default.createElement("option", { value: 7 }, "MAT\u00C9RIA LIDA"),
                                react_1.default.createElement("option", { value: 8 }, "APROVADA EM 1\u00BA DISCUSS\u00C3O"),
                                react_1.default.createElement("option", { value: 9 }, "APROVADA EM 2\u00BA DISCUSS\u00C3O"),
                                react_1.default.createElement("option", { value: 10 }, "APROVADA EM REGIME DE URG\u00CANCIA ESPECIAL"),
                                react_1.default.createElement("option", { value: 11 }, "APROVADA EM DISCUSS\u00C3O \u00DANICA"),
                                react_1.default.createElement("option", { value: 12 }, "APROVADO POR 2/3"),
                                react_1.default.createElement("option", { value: 13 }, "PEDIDO DE VISTA"))
